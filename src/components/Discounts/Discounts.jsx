...
const discountItems = [
  { id: 1, image: `${import.meta.env.BASE_URL}images/FoodPhoto1.png`, name: 'Greys Vage', days: 6, discount: '-30%' },
  { id: 2, image: `${import.meta.env.BASE_URL}images/FoodPhoto2.png`, name: 'Burger King', days: 6, discount: '-25%' },
  { id: 3, image: `${import.meta.env.BASE_URL}images/FoodPhoto3.png`, name: 'Pizza Hub', days: 7, discount: '-40%' },
  { id: 4, image: `${import.meta.env.BASE_URL}images/FoodPhoto4.png`, name: 'Taco Bell', days: 8, discount: '-20%' },
];
